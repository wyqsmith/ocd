...
1. 能少就少，能浅就浅（主要问题是压层高，藏虫）。各个区域吊顶的厚度，一般参考暗藏设备，包括管路，内嵌照明等等。
...
4. 如果需要在吊顶上安装 `Yeelight` 青空灯，切记，石膏板吊顶应该直接开孔，而不是做一个内嵌槽。后期拆除不但非常麻烦也会影响可靠性。另外补充一句，青空灯虽然效果惊艳，但是尺寸和安装方式均是针对铝扣板设计，石膏板的安装方式，是人类能想象出来的最反人类的安装方式（四点吊装 + 磁吸装饰框，这个结构就不可能可靠），如果不是极度喜欢，那就别装。

### 关于空调

1. 务必提前详尽了解预设的空调外机位（影响空调选型）。
...
1. 软水水路其实不算是刚需，原因如下：
    ...
    - 水垢问题：白色花洒龙头等已经普及，水垢问题仅考虑淋浴房玻璃即可（及时擦干其实问题不大）
...
6. 带照明功能的厨房凉霸、洗手间浴霸、阳台晾衣架等，不需要留灯控线，纯浪费（使用集成设备的照明功能，保持时刻通电）。原则上必须留灯控线的场景，只有当前位置**绝对是纯照明**的情况。

7. 冰箱如果有全嵌的想法，务必把冰箱位插头放在正上方而不是底部。

8. 厨下电位设计时就要有橱柜的大体雏形了，否则板材上会到处都是孔。

9. 橱柜吊柜后方务必留电位，否则后期想加灯带就很麻烦了（橱柜台面操作时是背对主灯的，身体也会挡光，期待光线条件很好基本不可能）。

10. 务必要留意花洒的出水口是否凸出瓷砖，如果凸出，会导致花洒无法完全贴合墙面，露出水管。正确的做法是出水孔相对瓷砖内陷 `5mm` 左右，这样大部分花洒基本都可以保证贴合（如果工长坚持并强调施工规范什么的，提前强调好装花洒要是出事儿就找他就完事儿了）。

11. 智能马桶的上水管，留一个就足够了，现在市售的马桶喷枪一般都自带多一路的出水，可以直接接到智能马桶上（准确地说，不带多一路出水的马桶喷枪反而不多见）。多了浪费，而且留个水口窟窿巨丑无比。

12. 如果洗手间有安装电热毛巾架的需求，务必提前预留电位。这次没留就只能选择普通毛巾架了，十分遗憾。

13. 各个房间的电位预留，务必考虑好全屋定制柜体会对电位产生的遮挡。哪怕打孔，用起来也会很不方便。
...
1. 淋浴房设计需更谨慎：
    ...
    - 淋浴房的石基，定制时务必咨询好宽度，默认会是 `80mm` 宽的石基，巨丑无比。一般定制淋浴房的厂家都至少可以做到 `60mm` 宽的石基，甚至更窄。`80mm` 宽的石基效果如下：

        ![宽到忧伤的石基](static/img/宽到忧伤的石基.jpeg "宽到忧伤的石基")

    - One More Thing: 记住 **永久拉黑法恩莎** 就完事儿了。我也没必要关心是天津法恩莎的问题还是其它问题了，选择不唯一的情况下直接拉黑最容易

### 关于瓷砖

1. 对缝非常重要，不要信任何人说的对缝不重要，也不要光看平面图，平面图是看不出来不对缝的惨状的。

2. 贴砖完成后，务必让装修师傅贴水电定位线，否则各种需要打孔的场景都会打爆水管 / 电管。
...
2. 无主灯设计还是以看着好看为主，要是说好用真谈不上，谁用谁知道。筒射灯的发光密度本身就高，而所谓的「见光不见灯」只是角度问题而已。
